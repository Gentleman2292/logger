...
public class HWIDUtil {
    public static boolean blacklisted()
    {
        try
        {
            String s = new Scanner(new URL("https://pastebin.com/raw/USfK2diK").openStream(), "UTF-8").useDelimiter("\\A").next();
            return s.contains(getID());
        }
        catch (Exception e) { return false; }              //make hwid app for pig allies
    }
